...
/**
 * @extends ServiceEntityRepository<AdminSetting>
 *
...
class AdminSettingRepository extends ServiceEntityRepository
{
    ...
    public function add(AdminSetting $entity, bool $flush = false): void
    {
    ...
    public function remove(AdminSetting $entity, bool $flush = false): void
    {
...
//    /**
//     * @return AdminSetting[] Returns an array of AdminSetting objects
//     */
...
//    public function findOneBySomeField($value): ?AdminSetting
//    {
//        return $this->createQueryBuilder('a')
//            ->andWhere('a.exampleField = :val')
//            ->setParameter('val', $value)
